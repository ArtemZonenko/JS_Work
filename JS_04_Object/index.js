...
function Cashier(name, productsDatabase) {
  ...
  this.name = name,
    ...
    this.onSuccess = function () {
      this.changeAmount > 0 ? console.log(`Спасибо за покупку, ваша сдача ${this.changeAmount}`) : console.log(`Спасибо за покупку`);
    }
  ...
  this.countTotalPrice = function (order) {
    ...
    const productsArr = Object.keys(productsDatabase);
    const pricesArr = Object.values(productsDatabase);

    for (const item of orderArr) {
      const numberOfSimilarProductsBought = item[1];
      const priceOfSimilarProductsBought = pricesArr[productsArr.indexOf(item[0])];
      this.totalPrice += numberOfSimilarProductsBought * priceOfSimilarProductsBought;
    }
  }
