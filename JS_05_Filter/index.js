 ...
 */
const getUsersByGender = (arr, gender) => arr.filter(i => i.gender === gender);
 ...
 */
const getTotalBalance = arr => arr.reduce((acc, guest) => acc + guest.balance, 0);
...
.sort()
.reduce((acc, elem) => acc.includes(elem) ? acc : acc.concat(elem), [])
